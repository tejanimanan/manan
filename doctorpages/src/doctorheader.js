                    ...
                    <ul className="main-nav">
                        ...
                        <li className="has-submenu">
                            ...
                            <ul className="submenu">
                                <li className="active"><a href="doctor-dashboard.html">Doctor Dashboard</a></li>
                                <li><a href="/appoinment">Appointments</a></li>
                                <li><a href="/my-assitant">Assitantlist</a></li>
                                <li><a href="/profile-setting">Profile Settings</a></li>
                                <li><a href="/reviews">Reviews</a></li>
                                <li><a href="/services">my Servies</a></li>
                                <li><a href="/register">Doctor Register</a></li>
                            </ul>
                        </li>
                       </ul>
                </div>
